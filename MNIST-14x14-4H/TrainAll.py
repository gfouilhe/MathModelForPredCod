    ...
    for iterationIndex in range(0, iterationNumber):
        ...
        for epoch in range(0, numberEpochs):  
            ...
            for i, data in enumerate(train_loader, 0):
                ...
                dTemp = torch.zeros(batchSize, 196)
                ...
                outputs,_, aTemp, bTemp, cTemp, dTemp, oTemp, _,_,_ = pcNet(inputs.view(batchSize,-1), aTemp, bTemp, cTemp, dTemp, oTemp, 'forward')

                for tt in range(timeSteps):
                    outputs, _, aTemp, bTemp, cTemp, dTemp, oTemp, _,_,_ = pcNet(inputs.view(batchSize,-1), aTemp, bTemp, cTemp, dTemp, oTemp, 'full')
