...
def main():
    ...
    for iterationIndex in range(0, iterationNumber):
        ...
        pcNet = PCMLP(featuresA, featuresB, featuresC, memory, alphaRec, betaFB, gammaFw)
        ...
        for epoch in range(0, numberEpochs):  
            ...
            for i, data in enumerate(train_loader, 0):
                ...
                cTemp = torch.zeros(batchSize, featuresC)
                ...
                outputs, iTemp, aTemp, bTemp, cTemp, oTemp, reconstructionA, reconstructionB = pcNet(inputs, aTemp, bTemp, cTemp, oTemp, 'forward')

                for tt in range(timeSteps):
                    outputs, iTemp, aTemp, bTemp, cTemp, oTemp, reconstructionA, reconstructionB = pcNet(inputs, aTemp, bTemp, cTemp, oTemp, 'full')
