    ...
    for iterationIndex in range(0, iterationNumber):
        ...
        for epoch in range(0, numberEpochs):  
            ...
            for i, data in enumerate(train_loader, 0):
                ...
                outputs, iTemp, aTemp, bTemp, cTemp, oTemp, reconstructionA,reconstructionB = pcNet(inputs.view(batchSize,-1), aTemp, bTemp, cTemp, oTemp, 'forward')

                for tt in range(timeSteps):
                    outputs, iTemp, aTemp, bTemp, cTemp, oTemp, reconstructionA,reconstructionB = pcNet(inputs.view(batchSize,-1), aTemp, bTemp, cTemp, oTemp, 'full')
