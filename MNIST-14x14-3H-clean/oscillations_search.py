...
def main():
    ...
    ########################
    for gammaFw in  gammaFwL:
        for alphaRec in alphaRecL:
            for betaFB in betaFBL:
                ...
                for alpha in alphaR :
                    ...
                    if plot:
                        plt.figure()
                        plt.scatter(*zip(*over_one),color='blue',label='rho > 1',s=0.005)
                        plt.scatter(*zip(*under_one),color='green',label='rho < 1',s=0.005)
                        plt.scatter(*zip(*good_params),color='red',label='rho = 1',s=0.005)
